...
public class VentanaAhorcado extends javax.swing.JFrame {
    ...
    //en esta primera versión del ahorcado versión del ahorcado, siempre es la 
     int numeroFallos = 0;
     ...
     public void chequeaLetra(String letra){
        ...
        palabraOculta = palabraOculta.toUpperCase(); //convierto la palabra a mayúscula.
        
        String palabraConGuiones = panelGuiones.getText();
        //que al chequear la letra, sea la correcta. Además de que contains devuelve true.
        ...
        //si al seleccionar la palabra incorrecta, sumas el número de fallos y
        //cambia la imagen del ahorcado(aparece una parte de su cuerpo).
        else{
            numeroFallos ++;
     ...
     private String eligePalabra(){
        String [] distintasPalabras = {"KAREL" , "RATON", "JESUS", "CINCO", "MOVIL"};
        Random aleatorio = new Random();
        int posicion = aleatorio.nextInt(distintasPalabras.length);
        return distintasPalabras[posicion].toUpperCase();
    }
    ...
    private void dibujaImagen(int numeroImagen){
        URL nombreImagen = null; //se queda inicializado a vacío.
        switch (numeroImagen){// nos sirve para determinar varios casos.
            ...
            case -1 : nombreImagen = getClass().getResource("/imagenes/GEEGEE.png"); break;  
            default : nombreImagen = getClass().getResource("/imagenes/gameOver.png"); break; //cualquier caso que no sea de los anteriores,
    ...
    private void initComponents() {
        ...
        panelGuiones.setBackground(new java.awt.Color(0, 0, 0));
        panelGuiones.setFont(new java.awt.Font("Times New Roman", 2, 48)); // NOI18N
        panelGuiones.setForeground(new java.awt.Color(255, 255, 0));
        panelGuiones.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        panelGuiones.setText("_ _ _ _ _");
        panelGuiones.setOpaque(true);
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(panelGuiones, javax.swing.GroupLayout.PREFERRED_SIZE, 88, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                .addComponent(panelAhorcado, javax.swing.GroupLayout.PREFERRED_SIZE, 194, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
